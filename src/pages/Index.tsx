                     ...
                     >
                       <div className="flex items-center gap-2 h-full">
                         ...
                         >
                          ...
                          <div className="flex min-w-0 flex-col flex-1 gap-1 overflow-hidden" style={{height: '48px', paddingTop: '8px', paddingBottom: '8px'}}>
                            <div className="flex items-center gap-2 min-w-0" style={{height: '20px'}}>
